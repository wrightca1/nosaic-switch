...
| [dell-s6000-on](../platform/dell-s6000-on/README.md) | x86_64 | td2 | onie-grub | planned | [install](../platform/dell-s6000-on/docs/install.md) · [build](../platform/dell-s6000-on/docs/build.md) · [hardware](../platform/dell-s6000-on/docs/hardware.md) |
...
- **cisco-n3172tq** — [tools/](../platform/cisco-n3172tq/tools/): `mki2cmap.sh`, `mkpolarity.sh`, `mkportmap.sh`, `mkretimer.sh`, `nxcon.py`
  ...
  board. Full instructions are in that board's README.
- **dell-s6000-on** — [tools/](../platform/dell-s6000-on/tools/): `rehearse.py`, `rehearse.sh`
  Run them once against a switch running the vendor's OS, drop the output
